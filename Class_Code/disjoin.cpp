...
int main(){
    ...
    cout<<" For search key "<<search_key<<", the parent key is: " <<find_set(search_key)<<" before union sets\n" ;
    union_sets(nodes[0],nodes[1]);

    cout<<" For search key "<<search_key<<", the parent key is: " <<find_set(search_key)<<" after union sets\n" ;
